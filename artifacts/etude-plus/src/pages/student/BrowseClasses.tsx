  ...
  const classes = data?.classes?.length ? data.classes : [
    {
      ...
      gradeLevel: "Baccalauréat", city: "Tunis", description: "Maîtrisez le programme du bac avec des exercices pratiques.", price: 45, durationHours: 2,
    ...
    },
    {
      ...
      gradeLevel: "Baccalauréat", city: "Sfax", description: "Comprendre les bases de la mécanique.", price: 40, durationHours: 1.5,
      isRecurring: false, isPublished: true, enrolledCount: 8, createdAt: new Date().toISOString(),
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1 text-xs text-muted-foreground">
                        <Star className="w-3 h-3 fill-primary text-primary" /> {cls.professor?.rating || "Nouveau"}
